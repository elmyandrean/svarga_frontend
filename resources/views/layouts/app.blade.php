...
<html class="no-js" lang="en">
    <head>
		...
		<!-- animate css -->
        <link rel="stylesheet" href="{{asset('library/css/animate.css')}}">
		<!-- jquery-ui.min css -->
        <link rel="stylesheet" href="{{asset('library/css/jquery-ui.min.css')}}">
		<!-- meanmenu css -->
        <link rel="stylesheet" href="{{asset('library/css/meanmenu.min.css')}}">
		<!-- owl.carousel css -->
        <link rel="stylesheet" href="{{asset('library/css/owl.carousel.css')}}">
        <!-- magnific-popup css -->
        <link rel="stylesheet" href="{{asset('library/css/magnific-popup.css')}}">
		<!-- font-awesome css -->
        <link rel="stylesheet" href="{{asset('library/css/font-awesome.min.css')}}">
		<!-- ionicons.min css -->
        <link rel="stylesheet" href="{{asset('library/css/ionicons.min.css')}}">
		<!-- nivo-slider.css -->
        <link rel="stylesheet" href="{{asset('library/css/nivo-slider.css')}}">
		<!-- style css -->
		<link rel="stylesheet" href="{{asset('library/style.css')}}">
		<!-- responsive css -->
        <link rel="stylesheet" href="{{asset('library/css/responsive.css')}}">
		<!-- modernizr css -->
        <script src="{{asset('library/js/vendor/modernizr-2.8.3.min.js')}}"></script>
    </head>
    <body class="home-3">
        <!--[if lt IE 8]>
		...
		<div id="page-wraper-2">
			...
			<header>
						...
						<div class="row">
							<div class="col-xl-4 col-lg-4 col-md-4 d-none d-md-block">
								...
								<div class="header-left-area">
									<ul>
										<li><a href="#">Curr<i class="fa fa-angle-down"></i></a>
											<div class="left-menu">
												<ul>
													<li><a href="#">€ Euro</a></li>
										...
										<li><a href="#">Lang<i class="fa fa-angle-down"></i></a>
											<div class="left-menu">
												<ul>
							...
							<div class="col-xl-4 col-lg-4 col-md-4 col-6">
								<!-- logo-area-start -->
								<div class="logo-area">
									<a href="index.html"><img src="{{asset('library/img/logo/1.png')}}" alt="logo" /></a>
								</div>
								<!-- logo-area-end -->
							</div>
							<div class="col-xl-4 col-lg-4 col-md-4 col-6">
				...
				<div class="header-menu-area d-none d-lg-block" id="sticky-header-2">
					<div class="container">
						<div class="row">
			...
			<div class="slider-area">
				<div id="slider">
					<img src="{{asset('library/assets/slider/1.jpeg')}}" alt="slider-img" title="#caption1" />
					<img src="{{asset('library/assets/slider/2.jpeg')}}" alt="slider-img" title="#caption2" />
					<img src="{{asset('library/assets/slider/3.jpeg')}}" alt="slider-img" title="#caption3" />
					<img src="{{asset('library/assets/slider/4.jpeg')}}" alt="slider-img" title="#caption3" />
					<img src="{{asset('library/assets/slider/5.jpeg')}}" alt="slider-img" title="#caption3" />
					<img src="{{asset('library/assets/slider/6.jpeg')}}" alt="slider-img" title="#caption3" />
					<img src="{{asset('library/assets/slider/7.jpeg')}}" alt="slider-img" title="#caption3" />
					<img src="{{asset('library/assets/slider/8.jpeg')}}" alt="slider-img" title="#caption3" />
				</div>
						...
						<div class="row">
							<div class="col-lg-12">
								<div class="slider-text">
									<h3 class="wow fadeInLeft" data-wow-delay=".3s">Stylish</h3>
									<h3 class="wow fadeInLeft" data-wow-delay=".5s">Male Clothes</h3>
				...
				<div class="nivo-html-caption" id="caption2" >
					<div class="container">
						<div class="row">
							<div class="col-lg-12">
								<div class="slider-text">
									<h3 class="wow fadeInLeft" data-wow-delay=".3s">Men’s</h3>
									<h3 class="wow fadeInLeft" data-wow-delay=".5s">Sunglasses</h3>
									<p class="wow fadeInLeft" data-wow-delay="1.3s">Discover the collection as styled by fashion icon Caroline Issa in our new season <br /> campaign.</p>
									<a href="#" class=" wow bounceInRight" data-wow-delay="1.5s">read more</a>
								</div>
							</div><!-- col -->
					...
					<div class="container">
						<div class="row">
							<div class="col-lg-12">
								<div class="slider-text">
									<h3 class="wow fadeInLeft" data-wow-delay=".3s">Stylish</h3>
									<h3 class="wow fadeInLeft" data-wow-delay=".5s">Female Clothes</h3>
									<p class="wow fadeInLeft" data-wow-delay="1.3s">Discover the collection as styled by fashion icon Caroline Issa in our new season <br /> campaign.</p>
									<a href="#" class=" wow bounceInRight" data-wow-delay="1.5s">read more</a>
								</div>
							</div><!-- col -->
					...
					<div class="br-bottom ptb-80">
						<div class="row">
							<div class="col-xl-4 col-lg-4 col-md-4 col-12">
								...
								<div class="single-banner-2 text-center mb-3">
									<div class="banner-icon">
										<a href="#"><img src="{{asset('library/img/banner/2.png')}}" alt="banner" /></a>
									</div>
							...
							<div class="col-xl-4 col-lg-4 col-md-4 col-12">
								...
								<div class="single-banner-2 text-center mb-3">
									<div class="banner-icon">
										<a href="#"><img src="{{asset('library/img/banner/3.png')}}" alt="banner" /></a>
									</div>
									<div class="banner-text">
							...
							<div class="col-xl-4 col-lg-4 col-md-4 col-12">
								...
								<div class="single-banner-2 text-center">
									<div class="banner-icon">
										<a href="#"><img src="{{asset('library/img/banner/4.png')}}" alt="banner" /></a>
									</div>
									<div class="banner-text">
					...
					<div class="row">
						...
						<div class="col-lg-12">
							...
							<div class="tab-menu mb-50 text-center">
								<ul class="nav">
									<li><a class="active" href="#Clothing" data-toggle="tab">Clothing</a></li>
                            ...
                            <div class="product-active owl-carousel">
                                <div class="product-wrapper-all">
                                    ...
                                    <div class="product-wrapper mb-40">
                                        <div class="product-img">
                                            <a href="#">
                                                <img src="{{asset('library/img/product/11.jpg')}}" alt="product" class="primary"/>
                                                <img src="{{asset('library/img/product/12.jpg')}}" alt="product" class="secondary"/>
                                            </a>
                                            <span class="sale">sale</span>
                                            <div class="product-icon">
                                                <a href="#" data-toggle="tooltip" title="Add to Cart"><i class="icon ion-bag"></i></a>
                                ...
                                <div class="product-wrapper-all">
                                    ...
                                    <div class="product-wrapper mb-40">
                                        <div class="product-img">
                                            <a href="#">
                                                <img src="{{asset('library/img/product/13.jpg')}}" alt="product" class="primary"/>
                                                <img src="{{asset('library/img/product/14.jpg')}}" alt="product" class="secondary"/>
                                            </a>
                                            <div class="product-icon">
                                                <a href="#" data-toggle="tooltip" title="Add to Cart"><i class="icon ion-bag"></i></a>
                                                <a href="#" data-toggle="tooltip" title="Compare this Product"><i class="icon ion-android-options"></i></a>
                                    ...
                                    <div class="product-wrapper">
                                        <div class="product-img">
                                            <a href="#">
                                                <img src="{{asset('library/img/product/3.jpg')}}" alt="product" class="primary"/>
                                                <img src="{{asset('library/img/product/4.jpg')}}" alt="product" class="secondary"/>
                                            </a>
                                            <div class="product-icon">
                                                <a href="#" data-toggle="tooltip" title="Add to Cart"><i class="icon ion-bag"></i></a>
                                                <a href="#" data-toggle="tooltip" title="Compare this Product"><i class="icon ion-android-options"></i></a>
                            ...
                            <div class="product-active owl-carousel">
                                <div class="product-wrapper-all">
                                    ...
                                    <div class="product-wrapper  mb-40">
                                        <div class="product-img">
                                            <a href="#">
                                                <img src="{{asset('library/img/product/21.jpg')}}" alt="product" class="primary"/>
                                                <img src="{{asset('library/img/product/22.jpg')}}" alt="product" class="secondary"/>
                                            </a>
                                            <span class="sale">sale</span>
                                            <div class="product-icon">
                                                <a href="#" data-toggle="tooltip" title="Add to Cart"><i class="icon ion-bag"></i></a>
                                ...
                                <div class="product-wrapper-all">
                                    ...
                                    <div class="product-wrapper">
                                        <div class="product-img">
                                            <a href="#">
                                                <img src="{{asset('library/img/product/31.jpg')}}" alt="product" class="primary"/>
                                                <img src="{{asset('library/img/product/32.jpg')}}" alt="product" class="secondary"/>
                                            </a>
                                            <div class="product-icon">
                                                <a href="#" data-toggle="tooltip" title="Add to Cart"><i class="icon ion-bag"></i></a>
                                                <a href="#" data-toggle="tooltip" title="Compare this Product"><i class="icon ion-android-options"></i></a>
                                ...
                                <div class="product-wrapper-all">
                                    ...
                                    <div class="product-wrapper mb-40">
                                        <div class="product-img">
                                            <a href="#">
                                                <img src="{{asset('library/img/product/25.jpg')}}" alt="product" class="primary"/>
                                                <img src="{{asset('library/img/product/26.jpg')}}" alt="product" class="secondary"/>
                                            </a>
                                            <span class="sale">sale</span>
                                            <div class="product-icon">
                                                <a href="#" data-toggle="tooltip" title="Add to Cart"><i class="icon ion-bag"></i></a>
                                    ...
                                    <div class="product-wrapper">
                                        <div class="product-img">
                                            <a href="#">
                                                <img src="{{asset('library/')}}img/product/7.jpg" alt="product" class="primary"/>
                                                <img src="{{asset('library/')}}img/product/8.jpg" alt="product" class="secondary"/>
                                            </a>
                                            <span class="sale">sale</span>
                                            <div class="product-icon">
                                                <a href="#" data-toggle="tooltip" title="Add to Cart"><i class="icon ion-bag"></i></a>
                                ...
                                <div class="product-wrapper-all">
                                    ...
                                    <div class="product-wrapper mb-40">
                                        <div class="product-img">
                                            <a href="#">
                                                <img src="{{asset('library/')}}img/product/27.jpg" alt="product" class="primary"/>
                                                <img src="{{asset('library/')}}img/product/28.jpg" alt="product" class="secondary"/>
                                            </a>
                                            <div class="product-icon">
                                                <a href="#" data-toggle="tooltip" title="Add to Cart"><i class="icon ion-bag"></i></a>
                                                <a href="#" data-toggle="tooltip" title="Compare this Product"><i class="icon ion-android-options"></i></a>
                                ...
                                <div class="product-wrapper-all">
                                    ...
                                    <div class="product-wrapper mb-40">
                                        <div class="product-img">
                                            <a href="#">
                                                <img src="{{asset('library/')}}img/product/29.jpg" alt="product" class="primary"/>
                                                <img src="{{asset('library/')}}img/product/30.jpg" alt="product" class="secondary"/>
                                            </a>
                                            <div class="product-icon">
                                                <a href="#" data-toggle="tooltip" title="Add to Cart"><i class="icon ion-bag"></i></a>
                                                <a href="#" data-toggle="tooltip" title="Compare this Product"><i class="icon ion-android-options"></i></a>
                                    ...
                                    <div class="product-wrapper">
                                        <div class="product-img">
                                            <a href="#">
                                                <img src="{{asset('library/')}}img/product/33.jpg" alt="product" class="primary"/>
                                                <img src="{{asset('library/')}}img/product/34.jpg" alt="product" class="secondary"/>
                                            </a>
                                            <div class="product-icon">
                                                <a href="#" data-toggle="tooltip" title="Add to Cart"><i class="icon ion-bag"></i></a>
                                                <a href="#" data-toggle="tooltip" title="Compare this Product"><i class="icon ion-android-options"></i></a>
                            ...
                            <div class="product-active owl-carousel">
                                <div class="product-wrapper-all">
                                    ...
                                    <div class="product-wrapper mb-40">
                                        <div class="product-img">
                                            <a href="#">
                                                <img src="{{asset('library/')}}img/product/23.jpg" alt="product" class="primary"/>
                                                <img src="{{asset('library/')}}img/product/24.jpg" alt="product" class="secondary"/>
                                            </a>
                                            <span class="sale">sale</span>
                                            <div class="product-icon">
                                                <a href="#" data-toggle="tooltip" title="Add to Cart"><i class="icon ion-bag"></i></a>
					...
					<div class="row">
						<div class="col-xl-6 col-lg-6 col-md-6 col-12">
							...
							<div class="single-banner mb-3">
								<div class="banner-img">
									<a href="#"><img src="{{asset('library/img/banner/7.jpg')}}" alt="banner" /></a>
								</div>
						...
						<div class="col-xl-6 col-lg-6 col-md-6 col-12">
							...
							<div class="single-banner">
								<div class="banner-img">
									<a href="#"><img src="{{asset('library/img/banner/8.jpg')}}" alt="banner" /></a>
								</div>
								<div class="banner-content-2">
                    ...
                    <div class="testimonial-active owl-carousel">
                        <div class="single-testimonial text-center">
                            <div class="testimonial-img">
                                <a href="#"><img src="{{asset('library/img/testimonial/1.jpg')}}" alt="man" /></a>
                            </div>
				...
				<div class="container">
					...
					<div class="blog-active owl-carousel">
                        ...
                        <div class="single-blog">
                            <div class="blog-img">
                                <a href="#"><img src="{{asset('library/img/blog/1.jpg')}}" alt="blog" /></a>
                                <div class="date">
                                    Aug <span>09</span>
                                </div>
                            </div>
                        ...
                        <div class="single-blog">
                            <div class="blog-img">
                                <a href="#"><img src="{{asset('library/img/blog/2.jpg')}}" alt="blog" /></a>
                                <div class="date">
                                    Aug <span>09</span>
                                </div>
                            </div>
                        ...
                        <div class="single-blog">
                            <div class="blog-img">
                                <a href="#"><img src="{{asset('library/img/blog/3.jpg')}}" alt="blog" /></a>
                                <div class="date">
                                    Aug <span>09</span>
                                </div>
                            </div>
						...
						<div class="row">
							<div class="col-xl-3 col-lg-3 col-md-3 col-12">
								...
								<div class="footer-logo mb-3">
									<a href="#"><img src="{{asset('library/img/logo/2.png')}}" alt="logo" /></a>
								</div>
								<!-- footer-logo-end -->
							</div>
							<div class="col-xl-6 col-lg-6 col-md-6 col-12">
							...
							<div class="modal-body">
								<div class="modal-img">
									<div class="single-img">
										<img src="assets/product/1/2.jpg" alt="hat" class="primary" />
									</div>
								</div>
								<div class="model-text">
									<h2><a href="#">Premium Skipping Rope Svarga 3 Meter  Tali Skipping Speed Rope - Hitam</a> </h2>
	  ...
	  <!-- page-wraper-start -->
        ...
        <script src="{{asset('library/js/vendor/jquery-v3.4.1.min.js')}}"></script>
        <!-- popper js -->
        <script src="{{asset('library/js/popper.js')}}"></script>
		<!-- bootstrap js -->
        <script src="{{asset('library/js/bootstrap.min.js')}}"></script>
		<!-- owl.carousel js -->
        <script src="{{asset('library/js/owl.carousel.min.js')}}"></script>
        <!-- magnific popup js -->
        <script src="{{asset('library/js/magnific-popup.js')}}"></script>
		<!-- meanmenu js -->
        <script src="{{asset('library/js/jquery.meanmenu.js')}}"></script>
		<!-- jquery-ui js -->
        <script src="{{asset('library/js/jquery-ui.min.js')}}"></script>
		<!-- wow js -->
        <script src="{{asset('library/js/wow.min.js')}}"></script>
		<!-- owl.carousel.min.js -->
        <script src="{{asset('library/js/owl.carousel.min.js')}}"></script>
		<!-- jquery.nivo.slider.js -->
        <script src="{{asset('library/js/jquery.nivo.slider.js')}}"></script>
		<!-- jquery.elevateZoom-3.0.8.min.js -->
        <script src="{{asset('library/js/jquery.elevateZoom-3.0.8.min.js')}}"></script>
		<!-- jquery.parallax-1.1.3.js -->
        <script src="{{asset('library/js/jquery.parallax-1.1.3.js')}}"></script>
		<!-- jquery.counterup.min.js -->
        <script src="{{asset('library/js/jquery.counterup.min.js')}}"></script>
		<!-- waypoints.min.js -->
        <script src="{{asset('library/js/waypoints.min.js')}}"></script>
		<!-- plugins js -->
        <script src="{{asset('library/js/plugins.js')}}"></script>
		<!-- main js -->
