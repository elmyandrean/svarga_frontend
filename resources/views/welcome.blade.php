								...
								<div class="header-left-area">
									<ul>
										...
										<li><a href="#">Lang<i class="fa fa-angle-down"></i></a>
											<div class="left-menu">
												<ul>
													<li><a href="#"><img src="{{asset('library/img/flag/1.jpg')}}" alt="flag" />   English</a></li>
													<li><a href="#"><img src="{{asset('library/img/flag/2.jpg')}}" alt="flag" />   French</a></li>
												</ul>
											</div>
										</li>
									</ul>
											...
											<div class="mini-cart-sub">
												<div class="cart-product">
													<div class="single-cart">
														<div class="cart-img">
															<a href="#"><img src="{{asset('library/img/product/1.jpg')}}" alt="book" /></a>
														</div>
														<div class="cart-info">
													...
													<div class="single-cart">
														<div class="cart-img">
															<a href="#"><img src="{{asset('library/img/product/3.jpg')}}" alt="book" /></a>
														</div>
														<div class="cart-info">
							...
							<div class="modal-body">
								<div class="modal-img">
									<div class="single-img">
										<img src="{{asset('library/assets/product/1/2.jpg')}}" alt="hat" class="primary" />
									</div>
								</div>
